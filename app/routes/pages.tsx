                                ...
                                <div className="md:w-3/4">
                                    <div className="px-2">
                                        <div className="font-normal text-lg text-justify space-y-4">
                                            ...
                                            <div className="text-medium text-2xl text-[#4356A2]">Shot Blasting Machine Supplier in India</div>
                                            ...
                                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
                                                <div>
                                                    <div className="text-medium text-2xl text-[#4356A2]">Our Team</div>
                                            ...
                                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
                                                ...
                                                <div>
                                                    <div className="text-medium text-2xl text-[#4356A2]">Why Us</div>
